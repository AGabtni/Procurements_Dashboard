...
import frTenders from "./locales/fr/tenders.json";
...
void i18n
  ...
  .init({
    resources: {
      "en-CA": { common: enCommon, settings: enSettings, auth: enAuth, dashboard: enDashboard, myCompany: enMyCompany, tenders: enTenders, errors: enErrors },
      "fr-CA": { common: frCommon, settings: frSettings, auth: frAuth, dashboard: frDashboard, myCompany: frMyCompany, tenders: frTenders, errors: frErrors },
    },
    lng: initialLang,
    fallbackLng: "en-CA",
    supportedLngs: [...SUPPORTED_LOCALES],
    ns: ["common", "settings", "auth", "dashboard", "myCompany", "tenders", "errors"],
    defaultNS: "common",
